...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      testimonials={[
        {
          name: "Elias Eid",
          handle: "@elias",
          testimonial: "Super Boost Gym is truly exceptional. The coaching is phenomenal.",
          rating: 5,
        ...
        },
        {
          name: "Matthew",
          handle: "@matthew",
          testimonial: "Satisfying fitness experience and feels like a home.",
          rating: 5,
        ...
        },
        {
          ...
          handle: "@muhammad",
          testimonial: "One of the best gyms in Dubai with everything you need.",
          rating: 5,
        ...
        },
        {
          name: "Sarah Ahmed",
          handle: "@sarah",
          testimonial: "Incredible facilities and very motivating instructors.",
          rating: 5,
        ...
        },
        {
          name: "David K",
          handle: "@davidk",
          testimonial: "Best value for money in Al Barsha by far.",
          rating: 5,
      ...
      imageSrc="http://img.b2bpic.net/free-photo/3d-render-grunge-interior-with-sunlight-shining-from-right-smokey-atmosphere_1048-12002.jpg?_wi=1"
      mediaAnimation="slide-up"
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/smiling-sporty-black-man-wearing-towel-around-neck_1262-16420.jpg",
          alt: "User 1",
        },
        {
          src: "http://img.b2bpic.net/free-photo/cheerful-boxer-looking-camera_171337-20044.jpg",
          alt: "User 2",
        },
        {
          src: "http://img.b2bpic.net/free-photo/side-view-woman-helping-man-gym_23-2149740152.jpg",
          alt: "User 3",
        },
        {
          src: "http://img.b2bpic.net/free-photo/smiling-sporty-black-man-wearing-towel-around-neck_1262-16420.jpg",
      ...
      features={[
        {
          ...
          description: "1-on-1 coaching for specific goals.",
          phoneOne: {
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/3d-render-grunge-interior-with-sunlight-shining-from-right-smokey-atmosphere_1048-12002.jpg?_wi=2",
          imageAlt: "dark gym background",
        },
        {
          title: "Strength & Conditioning",
          description: "Build foundational power and speed.",
          phoneOne: {
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/smiling-black-man-lifting-barbell-with-personal-trainer_1262-16411.jpg?_wi=3",
          imageAlt: "personal training session",
        },
        {
          title: "Boxing & Martial Arts",
          description: "Intense combat sports training.",
          phoneOne: {
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/illustration-person-weight-lifting_23-2151850200.jpg?_wi=3",
        ...
        },
        {
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/fitness-girl-hitting-punching-bag_23-2148017340.jpg?_wi=3",
          imageAlt: "boxing training gym",
        },
        {
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/full-shot-people-training-together-gym_23-2150289996.jpg?_wi=3",
          imageAlt: "gym group class",
        },
      ]}
  ...
  <div id="why-us" data-section="why-us">
      ...
      description={[
        "4.6 Star Rated Gym in Dubai.",
        "Professional MMA & fitness coaches.",
        "Full range of modern machines and weights.",
        "Prime location in Al Barsha, Dubai.",
  ...
  <div id="gallery" data-section="gallery">
      ...
      products={[
        ...
        },
        {
          ...
          price: "",
          variant: "Equipment",
          imageSrc: "http://img.b2bpic.net/free-photo/folder-floor-fitness-tools_23-2148010504.jpg",
        },
        {
          id: "5",
          name: "Stretching",
          price: "",
          variant: "Relaxation",
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-attractive-young-woman-doing-yoga-pilates-exercise_1153-5512.jpg",
        },
        {
          id: "6",
          name: "Reception",
  ...
  <div id="urgency" data-section="urgency">
      ...
      faqs={[
        {
          id: "1",
          title: "Why limit membership?",
          content: "To maintain a premium experience and avoid overcrowding.",
        },
        {
          id: "2",
          title: "Is the gym open daily?",
          content: "Yes, we are open 6:00 AM – 12:00 AM daily.",
        },
        {
          id: "3",
          title: "Are coaches available?",
          content: "Our elite trainers are on the floor throughout the day.",
        },
      ]}
